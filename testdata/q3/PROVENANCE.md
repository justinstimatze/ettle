...
positives. The `standup-rename` corpus has a *real* teamwide tangle built on
...
a tangle when people read it *incompatibly*. Firing on mere co-occurrence of "Q3"
...
Specificity target 0. A firm tangle on D1 means ettle confused "same deadline" for
