...
ettle is adopted by a high-trust team that opts in together, from the bottom up. This is a hard design constraint rather than a go-to-market preference — the natural growth path for a coordination tool is coercive, and the coercion is the failure.
...
1. **The team is the unit of adoption — never the individual.** A team decides together to run ettle. No one is dragged in by another member's usage.
...
### Why "useful at N=1" is a consent question, as much as a product one
